...
describe('Qizheng Horo Image Functions', () => {
  ...
  it('检查本命行星', () => {
    // prettier-ignore
    const expectPlanets = [
      { text: '日', left: 237.8096043882739, top: 428.6074947522182, tip: "日：殿、喜\n寅宫：4度45分58秒\n房宿：1度54分47秒\n均、顺" },
      { text: '月', left: 474.25083845350116, top: 316.27352139917684, tip: "月：旺\n酉宫：9度29分1秒\n娄宿：5度35分23秒\n天刑、七杀、奴仆\n迟、顺" },
      { text: '水', left: 204.47993380229772, top: 351.3706837097148, tip: "水：\n卯宫：15度47分21秒\n氐宿：0度47分34秒\n天印、正印、田宅\n均、顺" },
      { text: '金', left: 210.0757556713349, top: 379.2700049732135, tip: "金：\n卯宫：22度28分45秒\n氐宿：7度28分59秒\n天荫、偏财、妻妾\n疾、顺" },
      { text: '木', left: 204.90162419319802, top: 322.127027355802, tip: "木：殿\n卯宫：3度27分14秒\n角宿：9度41分53秒\n天耗、正财、兄弟\n疾、顺" },
      { text: '火', left: 258.73552896547415, top: 447.88937821683913, tip: "火：\n寅宫：12度53分37秒\n心宿：5度10分51秒\n天暗、伤官、相貌\n疾、顺" },
      { text: '土', left: 396.2143256222325, top: 462.6604136921898, tip: "土：垣、庙、乐\n子宫：24度23分37秒\n虚宿：1度4分51秒\n天贵、正官、男女\n均、顺" },
      { text: '气', left: 361.20823185104564, top: 204.25132775049977, tip: "气：\n未宫：21度2分9秒\n井宿：15度48分37秒\n天囚、偏印、疾厄\n均、顺" },
      { text: '罗', left: 454.21772256716775, top: 264.6692873229581, tip: "罗：\n申宫：2度56分58秒\n昴宿：3度36分46秒\n天禄、比肩、官禄\n均、逆" },
      { text: '计', left: 221.3498904632292, top: 405.39622234289976, tip: "计：旺\n寅宫：2度56分58秒\n房宿：0度5分47秒\n天权、劫财、命宫\n均、逆" },
  ...
  it('检查推运行星', () => {
    // prettier-ignore
    const expectPlanets = [
      { text: '日', left: 210.73252108897137, top: 168.29349869764286, tip: "日：旺\n巳宫：8度39分41秒\n张宿：3度3分4秒\n均、顺" },
      { text: '月', left: 236.92694994077692, top: 151.284944197078, tip: "月：\n巳宫：0度17分15秒\n星宿：3度5分18秒\n天耗、伤官、兄弟\n均、顺" },
      { text: '水', left: 154.70254777705898, top: 231.8669012439948, tip: "水：垣、旺、乐\n巳宫：29度0分57秒\n翼宿：5度24分30秒\n天荫、偏财、妻妾\n迟、逆、留" },
      { text: '金', left: 143.06404728784656, top: 255.2452977988662, tip: "金：垣、庙、乐\n辰宫：1度55分49秒\n翼宿：8度19分22秒\n天暗、劫财、相貌\n疾、顺" },
      ...
      { text: '计', left: 190.92873284879613, top: 185.31742569620928, tip:"计：庙\n巳宫：12度42分18秒\n张宿：7度5分41秒\n天刑、七杀、奴仆\n均、逆" },
